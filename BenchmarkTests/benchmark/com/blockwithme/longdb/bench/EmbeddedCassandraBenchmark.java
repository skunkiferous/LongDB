...
/** Benchmark Test Suite for Embedded Cassandra Backend. */
@AxisRange(min = 0, max = 1)
@BenchmarkMethodChart(filePrefix = "EmbeddedCassandraBenchMarks")
public class EmbeddedCassandraBenchmark extends AbstractBenchmarkTests {
