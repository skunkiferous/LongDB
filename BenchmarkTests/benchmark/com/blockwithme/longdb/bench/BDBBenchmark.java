...
/** This class provides benchmark test cases for BerkeleyDB. */
@AxisRange(min = 0, max = 1)
@BenchmarkMethodChart(filePrefix = "BerkeleyDBBenchmarks")
public class BDBBenchmark extends AbstractBenchmarkTests {
