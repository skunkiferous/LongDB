...
/** Interface implemented by the receiver of a query result set.
 * 
 * @author monster
 * @param <Q>
...
public interface QueryReceiver<Q, ROW extends RowKey<?>> {
     ...
     * @param result
     *        The result set. */
    void onQueryResult(final Q queryKey, final ResultSet<ROW> result);
