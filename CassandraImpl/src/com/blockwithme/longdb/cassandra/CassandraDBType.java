...
/** The Class Cassandra DB Type definition */
@ParametersAreNonnullByDefault
public class CassandraDBType extends AbstractBackendType {
    ...
    protected String configFileName() {
        return "CassandraConfig.properties";
    }
    ...
    @Override
    public String name() {
        return CassandraConstants.PROJECT_NAME;
    }
}
