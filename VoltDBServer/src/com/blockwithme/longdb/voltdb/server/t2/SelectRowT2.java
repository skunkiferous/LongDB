...
/** The SelectRow stored procedure for table T2. */
@ProcInfo(partitionInfo = "T2.ROW_KEY: 0", singlePartition = true)
public class SelectRowT2 extends com.blockwithme.longdb.voltdb.server.base.SelectRow {

    /*
     * (non-Javadoc)
     * 
     * @see com.paintedboxes.voltdb.server.base.SelectRow#run(long)
     */
    @Override
