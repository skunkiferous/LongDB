...
/** The 'SelectColumn' stored procedure for DefaultTable. */
@ProcInfo(partitionInfo = "defaulttable.ROW_KEY:0", singlePartition = true)
public class SelectColumnDefaulttable extends
        com.blockwithme.longdb.voltdb.server.base.SelectColumn {

    /* (non-Javadoc)
     * @see com.blockwithme.longdb.voltdb.server.base.SelectColumn#run(long,
     * long) */
    @Override
